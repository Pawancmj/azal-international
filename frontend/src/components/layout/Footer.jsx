...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    support: [
      ...
      { name: "Export Inquiry", path: "/contact#export" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-slate-800 dark:text-gray-400 mb-4">
              Premium carpets and flooring solutions for hospitality,
          ...
          {/* Products Links */}
          <div>
            <h4 className="text-slate-900 dark:text-white font-semibold mb-4">Products</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 pt-8 pb-8">
          <div className="max-w-md">
            ...
            <p className="text-sm text-slate-800 dark:text-gray-400 mb-4">
              Get the latest updates on new collections and industry insights.
            </p>
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-slate-800 dark:text-gray-400 mb-4 md:mb-0">
              © {currentYear} AZAL International. All rights reserved.
            </p>
