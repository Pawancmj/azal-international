...
const ProductDetails = () => {
    ...
    useGSAP(() => {
        ...
        // Animate gallery and info on load
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors pt-24 pb-12 overflow-hidden">
            <SEO
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <button
                    onClick={() => navigate("/collections")}
                    className="mb-8 flex items-center text-slate-600 dark:text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
                >
                    <svg
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            {product.images && product.images.map((img, index) => (
                                <div
                                    ...
                                    className={`cursor-pointer rounded-lg overflow-hidden border-2 transition-all duration-300 ${selectedImage === img ? 'border-amber-600 opacity-100' : 'border-transparent opacity-70 hover:opacity-100'} aspect-square`}
                                >
                                    <img
                                        src={img}
                    ...
                    <div className="product-info">
                        ...
                        <div className="flex flex-col gap-4">
                            <button
                                ...
                                className="w-full py-4 bg-green-500 text-white rounded-xl font-bold text-lg hover:bg-green-600 transition-colors flex items-center justify-center gap-2 shadow-lg shadow-green-500/20 hover:scale-[1.02] transform duration-200"
                            >
                                <svg
                                    className="w-6 h-6"
                                    fill="currentColor"
                ...
                {relatedProducts.length > 0 && (
                    <div className="border-t border-slate-200 dark:border-slate-800 pt-16 related-products">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {relatedProducts.map((related) => (
                                ...
                                >
                                    <div className="aspect-[4/3] overflow-hidden relative">
                                        ...
                                        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 gap-3">
                                            ...
                                            <button
                                                ...
                                                className="px-6 py-2 bg-amber-600 text-white rounded-lg font-semibold hover:bg-amber-700 transition-colors transform translate-y-4 group-hover:translate-y-0 duration-300 delay-75"
                                            >
                                                View Details
                                            </button>
                                        </div>
                                    ...
                                    <div className="p-4">
                                        <h3 className="font-bold text-slate-900 dark:text-slate-100 mb-1 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors cursor-pointer">
                                            {related.name}
                                        </h3>
