...
import { useGlobalState } from "../context/GlobalStateContext"; // Assuming this might be needed later, but standard for pages. Keeping imports clean.
...
const Contact = () => {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo(".contact-info-section",
      { x: 50, opacity: 0 },
      {
        x: 0, opacity: 1, duration: 0.8, ease: "power3.out", delay: 0.3,
        scrollTrigger: {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 contact-content">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-lg p-8 contact-form-section">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-amber-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500"
                />
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg
                    className="w-6 h-6 text-amber-600 mr-4 mt-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
